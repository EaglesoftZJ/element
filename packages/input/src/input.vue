...
<script>
  ...
  export default {
    ...
    mixins: [emitter, Migrating, tooltip],
    ...
    data() {
      return {
        currentValue: this.value || this.value === 0 ? this.value : '',
        textareaCalcStyle: {},
        prefixOffset: null,
        suffixOffset: null,
        hovering: false,
    ...
    computed: {
      ...
      showClear() {
        return this.clearable && !this.inputDisabled && this.currentValue !== '' && (this.focused || this.hovering);
      },
      isWordLimitVisible() {
