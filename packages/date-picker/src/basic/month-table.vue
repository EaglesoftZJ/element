...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'eg-element-ui-desk/src/utils/date-util';
  import { hasClass } from 'eg-element-ui-desk/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'eg-element-ui-desk/src/utils/util';
