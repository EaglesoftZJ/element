...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from 'eg-element-ui-desk/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from 'eg-element-ui-desk/src/utils/util';
