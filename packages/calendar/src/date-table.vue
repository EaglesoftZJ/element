<script>
import fecha from 'eg-element-ui-desk/src/utils/date';
import { range as rangeArr, getFirstDayOfMonth, getPrevMonthLastDays, getMonthDays, getI18nSettings, validateRangeInOneMonth } from 'eg-element-ui-desk/src/utils/date-util';
