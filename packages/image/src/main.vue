...
<script>
  ...
  import { on, off, getScrollContainer, isInContainer } from 'eg-element-ui-desk/src/utils/dom';
  import { isString, isHtmlElement } from 'eg-element-ui-desk/src/utils/types';
