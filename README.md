...
<p align="center">
  ...
  <a href="https://cdnjs.com/libraries/eg-element-ui-desk">
    <img src="https://img.shields.io/cdnjs/v/eg-element-ui-desk.svg">
  </a>
  <a href="https://www.npmjs.org/package/eg-element-ui-desk">
    <img src="https://img.shields.io/npm/v/eg-element-ui-desk.svg">
  </a>
  <a href="https://npmcharts.com/compare/eg-element-ui-desk?minimal=true">
    <img src="http://img.shields.io/npm/dm/eg-element-ui-desk.svg">
  </a>
  <br>
  <a href="http://img.badgesize.io/https://unpkg.com/eg-element-ui-desk/lib/index.js?compression=gzip&label=gzip%20size:%20JS">
    <img src="http://img.badgesize.io/https://unpkg.com/eg-element-ui-desk/lib/index.js?compression=gzip&label=gzip%20size:%20JS">
  </a>
  <a href="http://img.badgesize.io/https://unpkg.com/eg-element-ui-desk/lib/theme-chalk/index.css?compression=gzip&label=gzip%20size:%20CSS">
    <img src="http://img.badgesize.io/https://unpkg.com/eg-element-ui-desk/lib/theme-chalk/index.css?compression=gzip&label=gzip%20size:%20CSS">
  </a>
  <a href="#backers">
...
## Install
```shell
npm install eg-element-ui-desk -S
```

## Quick Start
``` javascript
import Vue from 'vue'
import Element from 'eg-element-ui-desk'
