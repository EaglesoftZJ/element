...
```html
<template>
  <el-select v-model="value" placeholder="请选择" filterable :popper-options="{ placement: 'right-start', arrowOffset: 0 }">
    <el-option
...
```html
<template>
  <el-select v-model="value5" multiple placeholder="请选择" :multiple-limit="2">
    <el-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
