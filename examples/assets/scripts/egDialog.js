      ...
      $edlg: {
          get() {
              ...
              openType.FullScreen = {
                  ...
                  dialogStyle: 'width:100%;height:100%;padding:0px;box-sizing:content-box;background-color: rgba(255,255,255,0);',
                  contentStyle: 'width:100%;height:100%;padding: 0px;top: 0px;overflow:hidden;background-color: rgba(255,255,255,0);',
              ...
              openType.Default = {
                  ...
                  dialogStyle: 'width:auto;height:auto;pointer-events:auto;box-sizing:content-box;top:100px; position:relative',
              ...
              openType.WindowSize = {
                  ...
                  contentStyle: 'padding: 20px; padding-top: 60px; box-sizing: border-box; position: relative; top: -40px; width:100%;height:100%;overflow:auto;',
              ...
              openType.fitHeight = {
                style: `width:100%;height:100%;pointer-events:none;display:flex;align-items:center;justify-content:center;display:flex`,
                dialogStyle: `width:auto;height:${wHeight - 40}px;pointer-events:auto;box-sizing:content-box;top: 20px; position:relative`,
                contentStyle: 'padding: 20px; padding-top: 60px; padding-bottom: 60px; box-sizing: border-box; position: relative; top: -40px; width:100%;height:100%;overflow:auto;',
                messageStyle: 'width:100%;height:100%;',
...
//     },
//     type: 'FullScreen', // ContentArea/Default/WindowSize
//     buttons: [{
//         text: '确定', // 显示名称
//         type: 'primary', // 类型
//         size: 'normal', // 大小
